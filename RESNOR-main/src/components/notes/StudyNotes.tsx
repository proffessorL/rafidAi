    ...
    <div className="flex flex-col h-full bg-[#0a0a0f]">
      ...
      <div className="shrink-0 border-b border-white/5 bg-white/[0.02] backdrop-blur-sm">
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.1, duration: 0.4, ease: [0.23, 1, 0.32, 1] }}
          className="mx-auto max-w-4xl px-4 sm:px-8 flex items-center justify-between h-12"
        >
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="mx-auto max-w-4xl px-4 sm:px-8 py-8 space-y-6">
          ...
          <input
            ...
            className="text-2xl sm:text-4xl font-extrabold text-slate-100 bg-transparent w-full tracking-tight placeholder:text-slate-700 focus:outline-none focus:ring-0"
          />
          ...
          <motion.div
            ...
            className="bg-white/5 border border-white/5 rounded-lg px-3 py-1.5 backdrop-blur-sm gap-1 w-max max-w-full overflow-x-auto shadow-sm flex items-center"
          >
            ...
            <div className="sm:hidden px-4 pt-3 pb-1">
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) => setSearchQuery(e.target.value)}
                  placeholder="Search notes..."
                  className="w-full h-9 rounded-lg border border-border/20 bg-muted/20 pl-8 pr-3 text-xs outline-none focus:border-emerald-500/30 focus:bg-background transition-all placeholder:text-muted-foreground/40"
                />
              </div>
            </div>
